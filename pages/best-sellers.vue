  ...
  <div dir="rtl" class="min-h-screen bg-gray-50">
    ...
    <div class="container mx-auto px-4 py-6 sm:py-8 md:py-10">
      <div class="text-center sm:text-right">
        <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-2">🔥 الأكثر مبيعاً</h1>
        <p class="text-gray-500 text-sm sm:text-base mb-6 sm:mb-8 md:mb-10">المنتجات الأكثر طلباً من العملاء</p>
      </div>
      ...
      <!-- Empty State -->
      <div v-if="!loading && bestSellers.length === 0" class="text-center py-16 sm:py-20">
        <p class="text-5xl sm:text-6xl mb-4 sm:mb-6">😕</p>
        <p class="text-xl sm:text-2xl text-gray-500">لا توجد منتجات حالياً</p>
...
const bestSellers = computed(() => products.value)
